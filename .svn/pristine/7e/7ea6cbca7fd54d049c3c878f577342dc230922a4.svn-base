...
public class JNTCIAttendance04forwardBLogic implements BLogic<JNTCIAttendance04selectInfo> {
	...
	public BLogicResult execute(JNTCIAttendance04selectInfo param){
