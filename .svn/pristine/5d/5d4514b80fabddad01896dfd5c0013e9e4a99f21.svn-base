	...
	<div style="position: relative;">
		...
		<div class="rightWidht">
			...
			<div id="tab-top" style="margin-top: 10px;">
				<ul>
					<li class="on"><a href="#">休暇申請</a></li>
					<li><ts:link action="/queryPersonalInformation1.do">补暇申請</ts:link></li>
				</ul>
			</div>
			<div
			...
			<div class="main-ctn ul-li" >
				<ts:form styleId="formId" action="/updateLeave01">

					<ul>
	                      <!--节假日列表  -->
					    <li><input type="hidden" id="detailDate"
                                value="<bean:write name="_jnTCIAttendance03Form" property="detailDate"/>" /></li>
						<li><label>申請者カード：</label>
						<html:hidden property="startIndex" name="_jnTCIAttendance03Form"></html:hidden>
						<html:hidden property="jnCard" />
						...
						<li><label>審査者：</label> <html:hidden property="projectPm" />
                         ...
                         <li ><label>申請方式：</label> <html:html>休暇</html:html></li>
						<!-- 休暇 を休む タイプ -->
						<li><label>休暇種類：<input type="hidden" id="selectCheck"
						...
						<li><label>休暇開始時間：</label> <html:text onclick="chooseDateCallBack();" onblur="cleanDate()"
						...
						<li><label>休暇時長：</label> <html:text styleId="date"
						...
						<li class="reason"><label>休暇事由：</label> <html:textarea
						...
						<li style="padding: 10px 0 0 200px;"><ts:submit styleClass="btn btn-blue"
							   ...
							   &nbsp;&nbsp;&nbsp; <input type="button" class="btn btn-green" id="resetButton"
							   style="width:60px;height:25px" onclick="resetCarel()" value="クリア" /></li>
					</ul>
				</ts:form>

				<ts:pageLinks id="userListPageLinks"
					action="/PagingQuery?jnCard=${_jnTCIAttendance03Form.jnCard}"
				...
				<table class="ctn" style="width: 100%; margin-top: 35px;">
					...
					<logic:notEmpty name="_jnTCIAttendance03Form"
						...
						<logic:iterate id="_jnTCIAttendance03FormBeans"
							...
							property="jntciAttendanceSelect03Dto">
							<ts:form action="/deleteEventAction" method="post">
