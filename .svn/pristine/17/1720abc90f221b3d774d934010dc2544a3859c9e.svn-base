...
public class JNTCIAttendanceSelect03Blogic1 implements BLogic<JNTCIAttendanceSelect03Dto>{
	...
	public BLogicResult execute(JNTCIAttendanceSelect03Dto param) {
		...
		String totalCount = queryDAO.executeForObject("viewCount1", jnCard , String.class);

		List<JNTCIAttendanceSelect03Dto> jntciAttendanceSelect03Dto = queryDAO.executeForObjectList("JNTCIAttendance03select1", jnCard,startIndex,row);
