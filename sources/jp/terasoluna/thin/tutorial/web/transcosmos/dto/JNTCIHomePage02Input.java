...
public class JNTCIHomePage02Input {
    private int info_id;
	...
	public String getFileNameJsp() {
        return fileNameJsp;
    }

    public void setFileNameJsp(String fileNameJsp) {
        this.fileNameJsp = fileNameJsp;
    }
