...
public class JNTCIEquip0308BLogic implements BLogic<JNTCIEquip03ListInput> {
	...
	public BLogicResult execute(JNTCIEquip03ListInput param) {
		...
		if ("1".equals(param.getHidden_state())) {
			...
			param.setHoyusha("倉庫");
			updateDAO.execute("getEquipapply0401", param);
			updateDAO.execute("getEquipapply04011", param);
			...
			String content = "nameさん<br>お疲れ様です。 <br><br>result.<br><br>以上。";
			...
			updateDAO.execute("getEquipapply0402", param);
			updateDAO.execute("getEquipapply04021", param);
